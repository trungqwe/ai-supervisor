...
const (
	...
	AuditStopOperationCallSucceeded       = "STOP_OPERATION_CALL_SUCCEEDED"
	AuditStopOperationCallFailed          = "STOP_OPERATION_CALL_FAILED"
	AuditStopOperationCallOutcomeUnknown  = "STOP_OPERATION_CALL_OUTCOME_UNKNOWN"
