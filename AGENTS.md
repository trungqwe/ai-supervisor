...
# SECTION 2: CURRENT PHASE RULES — P04 PRE-CONTRACT ARCHITECTURE REMEDIATION 6
...
> External Supervisor Audit 001 (docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_AUDIT_001.md) issued verdict REVISION_1_REQUIRED; Re-Audit 001 (docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_001.md) issued verdict REVISION_2_REQUIRED; Re-Audit 002 (docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_002.md) issued verdict REVISION_3_REQUIRED; Re-Audit 003 (docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_003.md) issued verdict REVISION_4_REQUIRED; Re-Audit 004 (docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_004.md) issued verdict REVISION_5_REQUIRED (findings P04-ARCH-R4-001 CLOSED, R4-002..003 SUBSTANTIVELY_CLOSED, R4-004..005 PARTIALLY_CLOSED, R4-006 SUBSTANTIVELY_CLOSED; five new findings P04-ARCH-R5-001..005 recorded with REMEDIATION_SUBMITTED). Six critical design blockers remain tracked: DESIGN_BLOCKER_P04_WORKTREE_BINDING, DESIGN_BLOCKER_P04_GIT_EVIDENCE_AUTHORITY, DESIGN_BLOCKER_P04_VERIFICATION_ISOLATION, DESIGN_BLOCKER_P04_REVIEW_SCHEMA_RECONCILIATION, DESIGN_BLOCKER_P04_EVIDENCE_ATOMICITY, and DESIGN_BLOCKER_P04_INERT_AO_HARNESS. Task Contract for P04 is BLOCKED_NOT_RELEASEABLE (Model A Draft Lineage, status invariant: NOT_RELEASED). Code writing for Phase P04 remains strictly held pending approved architecture and task contract release (P04_CODE = HELD_PENDING_APPROVED_ARCHITECTURE_AND_TASK_CONTRACT). P05_CODE = NOT_AUTHORIZED. ACTIVE_GATE = P04_PRECONTRACT_ARCHITECTURE_REMEDIATION_6.
>
1. **PHASE P04 PRE-CONTRACT ARCHITECTURE REMEDIATION DIRECTIVES**:
   ...
   - `PROPOSAL_P04_001 = REVISION_15_REQUIRED`; Remediated to Revision 16 — `PENDING_EXTERNAL_REVIEW`.
   - `PROPOSAL_P04_002 = REVISION_6_REQUIRED`; Remediated to Revision 7 — `PENDING_EXTERNAL_REVIEW` (`docs/proposals/PROPOSAL-P04-002-review-bundle-latency-semantics.md`).
   - `ADR_018 = REVISION_15_REQUIRED`; Remediated to Revision 16 — `DRAFT_PENDING_EXTERNAL_APPROVAL`.
   - `PLAN_P04_EVIDENCE_REVIEW = REVISION_15_REQUIRED`; Remediated to Revision 16 — `PLANNING_PENDING_EXTERNAL_AUDIT`.
   - External Re-Audit 014 (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_014.md`): findings `P04-ARCH-R14-001 = CLOSED_AT_DESIGN_LEVEL`, `P04-ARCH-R14-002 = PARTIALLY_CLOSED`, and two new findings `P04-ARCH-R15-001` and `P04-ARCH-R15-002` recorded with remediation submitted.
   ...
   - Tracked Architecture Design Blockers:
     * `DESIGN_BLOCKER_P04_WORKTREE_BINDING = REMEDIATION_SUBMITTED`
     * `DESIGN_BLOCKER_P04_GIT_EVIDENCE_AUTHORITY = REMEDIATION_SUBMITTED`
     * `DESIGN_BLOCKER_P04_VERIFICATION_ISOLATION = REMEDIATION_SUBMITTED`
   ...
   - Remediated Pre-Contract Documents Submitted (Revision 14 / Revision 7 / Revision 5 / Model A Draft):
     * Proposal 001: `docs/proposals/PROPOSAL-P04-001-evidence-review-engine-boundaries.md` (`PENDING_EXTERNAL_REVIEW`, Revision 16)
     * Proposal 002: `docs/proposals/PROPOSAL-P04-002-review-bundle-latency-semantics.md` (`PENDING_EXTERNAL_REVIEW`, Revision 7)
     * Draft ADR: `docs/adr/DRAFT-ADR-018-evidence-review-and-verification-isolation.md` (`DRAFT_PENDING_EXTERNAL_APPROVAL`, Revision 16)
     * Execution Plan: `docs/plans/PLAN-P04-EVIDENCE-REVIEW.md` (`PLANNING_PENDING_EXTERNAL_AUDIT`, Revision 16)
     ...
     * Re-Audit 014 Record: `docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_014.md` (`REVISION_15_REQUIRED`)
   - Next Approved Action: Await External Supervisor re-audit of Revision 16 remediation deliverables. Zero production or test code writing for Phase P04 or P05 until formal Task Contract release.
...
3. **EXPLICITLY FORBIDDEN IN THIS PRE-CONTRACT REMEDIATION STAGE**:
   - Absolutely NO writing of Phase P04 Evidence & Review Engine code until formal Task Contract release (`P04_CODE = HELD_PENDING_APPROVED_ARCHITECTURE_AND_TASK_CONTRACT`);
   ...
   - Absolutely NO restoring candidate recovery artifact into `internal/store/session_lifecycle.go` or merging it into source code.
...
4. **FINAL GOVERNANCE STATE**:
   ...
   - `FINDING_P03_EXIT_R1_001_THROUGH_004 = CLOSED` (`docs/audits/P03_EXIT_GATE_EXTERNAL_REAUDIT_001.md`)
   - `FINDING_P03_EXIT_R2_001 = CLOSED_WITH_BYTE_EXACT_RECOVERY_AND_PROVENANCE_LIMITATION` (`docs/audits/P03_EXIT_GATE_EXTERNAL_REAUDIT_002.md`)
   - `CANDIDATE_WIP_STATUS = CLOSED_WITH_BYTE_EXACT_RECOVERY_AND_PROVENANCE_LIMITATION` (preserved externally in `D:\TU_CODE\ai-supervisor-user-wip-recovery\P03-EXIT-R2-001`)
   - `P03_EXIT_GATE = EXTERNAL_AUDIT_APPROVED`
   - `PHASE_P03 = COMPLETE`
   - `P04_PRECONTRACT_AUDIT_001 = REVISION_1_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_AUDIT_001.md`)
   - `P04_AUDIT_001_ERRATUM_001 = FORMALLY_RECORDED`
   - `P04_REAUDIT_001 = REVISION_2_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_001.md`)
   - `P04_AUDIT_001_ERRATUM_002 = FORMALLY_RECORDED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_AUDIT_001_ERRATUM_002.md`)
   - `P04_REAUDIT_002 = REVISION_3_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_002.md`)
   - `P04_AUDIT_001_ERRATUM_003 = FORMALLY_RECORDED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_AUDIT_001_ERRATUM_003.md`)
   - `P04_REAUDIT_003 = REVISION_4_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_003.md`)
   - `P04_REAUDIT_004 = REVISION_5_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_004.md`)
   - `P04_REAUDIT_005 = REVISION_6_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_005.md`)
   - `DESIGN_BLOCKER_P04_WORKTREE_BINDING = REMEDIATION_SUBMITTED`
   - `DESIGN_BLOCKER_P04_GIT_EVIDENCE_AUTHORITY = REMEDIATION_SUBMITTED`
   - `DESIGN_BLOCKER_P04_VERIFICATION_ISOLATION = REMEDIATION_SUBMITTED`
   - `DESIGN_BLOCKER_P04_REVIEW_SCHEMA_RECONCILIATION = REMEDIATION_SUBMITTED`
   ...
   - `DESIGN_BLOCKER_P04_INERT_AO_HARNESS = REMEDIATION_SUBMITTED`
   - `P04_TASK_CONTRACT = NOT_RELEASED`
   - `P04_WORKTREE_BINDING_PROOF_CONTRACT = RETIRED_NON_EXECUTABLE_DRAFT` (status invariant: `NOT_RELEASED`)
   - `P04_CODE = HELD_PENDING_APPROVED_ARCHITECTURE_AND_TASK_CONTRACT`
   - `P04_REAUDIT_006 = REVISION_7_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_006.md`)
   - `P04_REAUDIT_007 = REVISION_8_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_007.md`)
   - `P04_REAUDIT_008 = REVISION_9_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_008.md`)
   - `P04_REAUDIT_009 = REVISION_10_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_009.md`)
   - `P04_REAUDIT_010 = REVISION_11_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_010.md`)
   - `P04_REAUDIT_011 = REVISION_12_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_011.md`)
   - `P04_REAUDIT_012 = REVISION_13_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_012.md`)
   - `P04_REAUDIT_013 = REVISION_14_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_013.md`)
   - `P04_REAUDIT_014 = REVISION_15_REQUIRED` (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_014.md`)
   - `PROPOSAL_P04_001 = REVISION_15_REQUIRED` (Remediated: Revision 16 submitted)
   - `PROPOSAL_P04_002 = REVISION_6_REQUIRED` (Remediated: Revision 7 submitted)
   - `ADR_018 = REVISION_15_REQUIRED` (Remediated: Revision 16 submitted)
   - `PLAN_P04_EVIDENCE_REVIEW = REVISION_15_REQUIRED` (Remediated: Revision 16 submitted)
   - `P04-ARCH-R14-001 = CLOSED_AT_DESIGN_LEVEL`
   - `P04-ARCH-R14-002 = PARTIALLY_CLOSED`
   - `P04-ARCH-R15-001..002 = REMEDIATION_SUBMITTED`
   - `ACTIVE_GATE = P04_PRECONTRACT_ARCHITECTURE_REMEDIATION_15`
   - `P05_CODE = NOT_AUTHORIZED`
