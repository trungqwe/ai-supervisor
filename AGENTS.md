...
1. **PHASE P04 PRE-CONTRACT ARCHITECTURE REMEDIATION DIRECTIVES**:
   ...
   - `PROPOSAL_P04_001 = REVISION_8_REQUIRED`; Remediated to Revision 9 — `PENDING_EXTERNAL_REVIEW`.
   - `PROPOSAL_P04_002 = REVISION_2_REQUIRED`; Remediated to Revision 3 — `PENDING_EXTERNAL_REVIEW` (`docs/proposals/PROPOSAL-P04-002-review-bundle-latency-semantics.md`).
   - `ADR_018 = REVISION_8_REQUIRED`; Remediated to Revision 9 — `DRAFT_PENDING_EXTERNAL_APPROVAL`.
   - `PLAN_P04_EVIDENCE_REVIEW = REVISION_8_REQUIRED`; Remediated to Revision 9 — `PLANNING_PENDING_EXTERNAL_AUDIT`.
   - External Re-Audit 007 (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_007.md`): findings `P04-ARCH-R7-001 = CLOSED_AT_DESIGN_LEVEL`, `P04-ARCH-R7-002..006 = PARTIALLY_CLOSED`, and five new findings `P04-ARCH-R8-001..005` recorded with remediation submitted.
...
4. **FINAL GOVERNANCE STATE**:
   ...
   - `P04_CODE = HELD_PENDING_APPROVED_ARCHITECTURE_AND_TASK_CONTRACT`
   - `PROPOSAL_P04_001 = REVISION_8_REQUIRED` (Remediated: Revision 9 submitted)
   - `PROPOSAL_P04_002 = PENDING_EXTERNAL_REVIEW`
   - `ADR_018 = REVISION_8_REQUIRED` (Remediated: Revision 9 submitted)
   - `PLAN_P04_EVIDENCE_REVIEW = REVISION_8_REQUIRED` (Remediated: Revision 9 submitted)
