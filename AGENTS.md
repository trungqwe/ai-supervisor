...
4. **FINAL GOVERNANCE STATE**:
   ...
   - `ACTIVE_GATE = TASK_P03_004_CONTRACT_PLANNING` (chờ re-audit gói thiết kế Revision 8, audit record 007 (ranh giới tích hợp store.Open & 4 invariants) và DRAFT Task Contract 004 JSON cho TASK-P03-004)
   - `ADR_017 = REVISION_8_PENDING_EXTERNAL_AUDIT`
