...
1. **PHASE P04 PRE-CONTRACT ARCHITECTURE REMEDIATION DIRECTIVES**:
   ...
   - `PROPOSAL_P04_001 = REVISION_7_REQUIRED`; Remediated to Revision 8 — `PENDING_EXTERNAL_REVIEW`.
   - `PROPOSAL_P04_002 = REVISION_1_REQUIRED`; Remediated to Revision 2 — `PENDING_EXTERNAL_REVIEW` (`docs/proposals/PROPOSAL-P04-002-review-bundle-latency-semantics.md`).
   - `ADR_018 = REVISION_7_REQUIRED`; Remediated to Revision 8 — `DRAFT_PENDING_EXTERNAL_APPROVAL`.
   - `PLAN_P04_EVIDENCE_REVIEW = REVISION_7_REQUIRED`; Remediated to Revision 8 — `PLANNING_PENDING_EXTERNAL_AUDIT`.
   - External Re-Audit 006 (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_006.md`): findings `P04-ARCH-R6-001 = PARTIALLY_CLOSED`, `P04-ARCH-R6-002 = CLOSED`, `P04-ARCH-R6-003..006 = PARTIALLY_CLOSED`, and six new findings `P04-ARCH-R7-001..006` recorded with remediation submitted.
   ...
   - Remediated Pre-Contract Documents Submitted (Revision 7 / Revision 5 / Model A Draft):
     * Proposal 001: `docs/proposals/PROPOSAL-P04-001-evidence-review-engine-boundaries.md` (`PENDING_EXTERNAL_REVIEW`, Revision 7)
     * Proposal 002: `docs/proposals/PROPOSAL-P04-002-review-bundle-latency-semantics.md` (`PENDING_EXTERNAL_REVIEW`)
     * Draft ADR: `docs/adr/DRAFT-ADR-018-evidence-review-and-verification-isolation.md` (`DRAFT_PENDING_EXTERNAL_APPROVAL`, Revision 7)
     * Execution Plan: `docs/plans/PLAN-P04-EVIDENCE-REVIEW.md` (`PLANNING_PENDING_EXTERNAL_AUDIT`, Revision 7)
     ...
     * Re-Audit 005 Record: `docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_005.md` (`REVISION_6_REQUIRED`)
   - Next Approved Action: Await External Supervisor re-audit of Revision 7 remediation deliverables. Zero production or test code writing for Phase P04 or P05 until formal Task Contract release.
...
4. **FINAL GOVERNANCE STATE**:
   ...
   - `P04_CODE = HELD_PENDING_APPROVED_ARCHITECTURE_AND_TASK_CONTRACT`
   - `PROPOSAL_P04_001 = REVISION_7_REQUIRED` (Remediated: Revision 8 submitted)
   - `PROPOSAL_P04_002 = PENDING_EXTERNAL_REVIEW`
   - `ADR_018 = REVISION_7_REQUIRED` (Remediated: Revision 8 submitted)
   - `PLAN_P04_EVIDENCE_REVIEW = REVISION_7_REQUIRED` (Remediated: Revision 8 submitted)
   ...
   - `P04-ARCH-R4-001 = CLOSED`; `P04-ARCH-R4-002 = SUBSTANTIVELY_CLOSED_AT_WIRE_DESIGN_LEVEL`; `P04-ARCH-R4-003 = SUBSTANTIVELY_CLOSED_AT_DESIGN_LEVEL`; `P04-ARCH-R4-004..005 = PARTIALLY_CLOSED`; `P04-ARCH-R4-006 = SUBSTANTIVELY_CLOSED`
   - `P04-ARCH-R5-001 = SUBSTANTIVELY_CLOSED_WITH_R6_FOLLOWUP`; `P04-ARCH-R5-002..005 = PARTIALLY_CLOSED`
   - `P04-ARCH-R6-001..006 = REMEDIATION_SUBMITTED`
   - `ACTIVE_GATE = P04_PRECONTRACT_ARCHITECTURE_REMEDIATION_7`
   - `P05_CODE = NOT_AUTHORIZED`
