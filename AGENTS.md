...
1. **PHASE P04 PRE-CONTRACT ARCHITECTURE REMEDIATION DIRECTIVES**:
   ...
   - `PROPOSAL_P04_001 = REVISION_12_REQUIRED`; Remediated to Revision 13 — `PENDING_EXTERNAL_REVIEW`.
   ...
   - `ADR_018 = REVISION_12_REQUIRED`; Remediated to Revision 13 — `DRAFT_PENDING_EXTERNAL_APPROVAL`.
   - `PLAN_P04_EVIDENCE_REVIEW = REVISION_12_REQUIRED`; Remediated to Revision 13 — `PLANNING_PENDING_EXTERNAL_AUDIT`.
   - External Re-Audit 011 (`docs/audits/P04_PRECONTRACT_ARCHITECTURE_EXTERNAL_REAUDIT_011.md`): findings `P04-ARCH-R11-001 = CLOSED_AT_DESIGN_LEVEL`, `P04-ARCH-R11-002 = NOT_CLOSED`, `P04-ARCH-R11-003 = PARTIALLY_CLOSED`, `P04-ARCH-R11-004 = SUBSTANTIVELY_CLOSED_WITH_R12_FOLLOWUP`, and four new findings `P04-ARCH-R12-001..004` recorded with remediation submitted.
...
4. **FINAL GOVERNANCE STATE**:
   ...
   - `PROPOSAL_P04_001 = REVISION_12_REQUIRED` (Remediated: Revision 13 submitted)
   - `PROPOSAL_P04_002 = REVISION_6_REQUIRED` (Remediated: Revision 7 submitted)
   - `ADR_018 = REVISION_12_REQUIRED` (Remediated: Revision 13 submitted)
   - `PLAN_P04_EVIDENCE_REVIEW = REVISION_12_REQUIRED` (Remediated: Revision 13 submitted)
   - `P04-ARCH-R11-001 = CLOSED_AT_DESIGN_LEVEL`
   - `P04-ARCH-R11-002 = NOT_CLOSED`
   - `P04-ARCH-R11-003 = PARTIALLY_CLOSED`
   - `P04-ARCH-R11-004 = SUBSTANTIVELY_CLOSED_WITH_R12_FOLLOWUP`
   - `P04-ARCH-R12-001..004 = REMEDIATION_SUBMITTED`
   - `ACTIVE_GATE = P04_PRECONTRACT_ARCHITECTURE_REMEDIATION_12`
   - `P05_CODE = NOT_AUTHORIZED`
