...
> **Contract ID**: `CONTRACT-TASK-P04-WORKTREE-BINDING-PROOF-02`
> **Task ID**: `TASK-P04-WORKTREE-BINDING-PROOF` (Bounded Empirical Proof for Worktree Path Authority and Binding)
> **Revision Number**: `2`
> **Supersedes Contract ID**: `CONTRACT-TASK-P04-WORKTREE-BINDING-PROOF-01`
> **Phase ID**: `P04`
...
> **Authority**: Formulated pursuant to accepted `docs/24_CHANGE_GOVERNANCE.md`, `AGENTS.md`, `PROPOSAL-P04-001` (Rev 4), `DRAFT-ADR-018` (Rev 4), and `PLAN-P04-WORKTREE-BINDING-PROOF.md` (Rev 2).
...
```json
{
  "contract_id": "CONTRACT-TASK-P04-WORKTREE-BINDING-PROOF-02",
  "task_id": "TASK-P04-WORKTREE-BINDING-PROOF",
  "revision_number": 2,
  "supersedes_contract_id": "CONTRACT-TASK-P04-WORKTREE-BINDING-PROOF-01",
  "phase_id": "P04",
  ...
  "verification_requests": [
    ...
    },
    {
      ...
      "profile_id": "proof-ao-session-probe",
      "parameters": {
        "probe_kind": "restart-and-restore-session",
        "harness": "mock-inert"
      },
      "timeout_seconds": 60
    },
...
2. **Recorded Design Blockers**:
   - `BLOCKER-P04-PROOF-PROFILE = PROFILE_NOT_YET_REGISTERED`: The profile `proof-investigator` is not yet registered in the live worker profile catalog.
   ...
   - `DESIGN_BLOCKER_P04_INERT_AO_HARNESS = OPEN`: An inert, zero-LLM AO test harness mode must be authoritatively proven before dispatch.
...
4. **Execution Authority**:
   - Zero worker authority to supply raw executables, command strings, endpoints, or roots.
